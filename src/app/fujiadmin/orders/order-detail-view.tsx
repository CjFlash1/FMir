...
// Approximate Discount Calculation (Client-side estimation based on base prices)
// Note: This is an estimation because we don't store the "original base price" in the order.
// We assume standard prices: 10x15=5.90, 15x21=12.00, etc. (Adjust as needed or fetch from config in future)
const estimatedDiscount = useMemo(() => {
    // This is purely visual and might not perfectly match historical data
    // If you want exact data, back-end storage needs update.
    return 0;
}, []);
...
return (
    <div className="space-y-6 max-w-5xl mx-auto relative">
                ...
                {orderTTN && (
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2 bg-green-50 border border-green-200 px-3 py-1.5 rounded-lg shadow-sm">
                            ...
                            <span className="text-xs font-bold text-green-700">{orderTTN}</span>
                            <a
                        ...
                        <div className="flex gap-1">
                            <a
                                ...
                                target="_blank"
                            >
                                <Button variant="outline" size="sm" className="h-9 w-9 p-0 border-blue-200 hover:bg-blue-50" title="PDF">
                            ...
                            <a
                                ...
                                target="_blank"
                            >
                                <Button variant="outline" size="sm" className="h-9 w-9 p-0 border-orange-200 hover:bg-orange-50" title="Sticker">
        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            {/* Shipping Info - UPDATED with Delivery Cost */}
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                <div className="flex items-center gap-3 mb-4 text-slate-900">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                ...
                <div className="flex flex-col items-end">
                    ...
                    {/* Discount Placeholder - Only show if reasonable */}
                    {/* <div className="text-xs text-green-600 font-medium">Враховуючи знижки</div> */}
                </div>
            </div>
                                    ...
                                    <td className="px-3 md:px-6 py-4 text-right">
                                        {firstFile && (
                                            <a
                                                ...
                                                download={(firstFile.original || 'photo').replace(/\.[^/.]+$/, "") + ".jpg"}
                                                target="_blank"
                                                className="inline-flex items-center justify-center px-2 md:px-4 py-2 border border-slate-200 shadow-sm text-xs md:text-sm font-medium rounded-md text-slate-700 bg-white hover:bg-slate-50 focus:outline-none"
                                            >
